...
//用于列出某个字母开头的单词，对应WordActivity
class DetailActivity : AppCompatActivity() {
    companion object {
        const val LETTER = "letter"
        const val SEARCH_PREFIX = "https://www.baidu.com/s?wd="
    }
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val wordsRecyclerView = binding.recyclerView
        wordsRecyclerView.layoutManager = LinearLayoutManager(this)
        wordsRecyclerView.adapter = WordAdapter(letterId, this)
